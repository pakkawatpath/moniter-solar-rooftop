    ...
    <div class="container text-center">
        <div class="row">
            ...
            <div class="col" style="margin-top: 70px;">
                ...
                <table id="t2">
                    <tr>
                        <th colspan="3" id="head1">PV Current</th>
                    </tr>
                    <tr>
                    ...
                    <?php foreach ($fields as $label => $file): ?>
                        <tr>
                            ...
                            <td id="colorf0f0f0">
                                <iframe src="./pv_current_data/<?php echo $file; ?>.php?location_id=<?php echo $location_id; ?>&device_id=<?php echo $device_id ; ?>" height="23" width="110" scrolling="no"></iframe>
                            </td>
                        </tr>
                    <?php endforeach; ?>
